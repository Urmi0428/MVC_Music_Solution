...
namespace MVC_Music.Data
{
    public class MusicContext : DbContext
    {
        ...
        public DbSet<PerformanceReportVM> Per { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {

            //For the Performance Report view modal
            modelBuilder.Entity<PerformanceReportVM>()
                        .ToView (nameof(Per))
                         .HasNoKey(); ;
        ...
        public DbSet<MVC_Music.ViewModels.PerformanceReportVM> PerformanceReportVM { get; set; }
    }
}
