    ...
    public class InstrumentsController : CustomControllers.ElephantController
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if (User.IsInRole("Staff"))
            {
                ...
                {
                    ModelState.AddModelError("", "As a Staff , you can not edit this" + "Instrument because you did not created them in to the System");
                }
            }
            PopulatePlaysInstrumentData(instrument);
            return View(instrument);
        ...
        public async Task<IActionResult> InsertFromExcel(IFormFile theExcel)
        {
            ...
            return RedirectToAction("Index", "Instruments", new { Tab = ControllerName() + "-Tab" });
        }
